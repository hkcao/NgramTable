"""
Python Suffix with n-gram root: comparison against C++ Suffix and Trie-3g.
"""
import argparse
import gc
import json
...
def main():
    parser = argparse.ArgumentParser(
        description="PySuffix vs C++ Suffix vs Trie-3g comparison")
    ...
    configs = [
        ...
        # ns=1 + min_match=2: same data structure as ns=1,
        # but skip match_len<2 to test if it matches ns=2 quality
        ("ns=1 min_m=2", ngram_spec, {
            "VLLM_NGRAM_USE_HASH": "0",
            "VLLM_NGRAM_USE_TRIE": "0",
            "VLLM_NGRAM_USE_PYSUFFIX": "1",
            "VLLM_PYSUFFIX_ROOT_NS": "1",
            "VLLM_PYSUFFIX_MIN_PROB": "0.1",
            "VLLM_PYSUFFIX_MIN_MATCH_LEN": "2",
        }),
        ("PySuffix ns=2", ngram_spec, {
            "VLLM_NGRAM_USE_HASH": "0",
            "VLLM_NGRAM_USE_TRIE": "0",
            "VLLM_NGRAM_USE_PYSUFFIX": "1",
            "VLLM_PYSUFFIX_ROOT_NS": "2",
            "VLLM_PYSUFFIX_MIN_PROB": "0.1",
        }),
        ("ns=1 min_m=3", ngram_spec, {
            "VLLM_NGRAM_USE_HASH": "0",
            "VLLM_NGRAM_USE_TRIE": "0",
            "VLLM_NGRAM_USE_PYSUFFIX": "1",
            "VLLM_PYSUFFIX_ROOT_NS": "1",
            "VLLM_PYSUFFIX_MIN_PROB": "0.1",
            "VLLM_PYSUFFIX_MIN_MATCH_LEN": "3",
        }),
        ("PySuffix ns=3", ngram_spec, {
            "VLLM_NGRAM_USE_HASH": "0",
            "VLLM_NGRAM_USE_TRIE": "0",
            "VLLM_NGRAM_USE_PYSUFFIX": "1",
            "VLLM_PYSUFFIX_ROOT_NS": "3",
            "VLLM_PYSUFFIX_MIN_PROB": "0.1",
        }),
    ]
    ...
    # Summary
    print("\n\n" + "=" * 130)
    print("PYSUFFIX vs C++ SUFFIX vs TRIE-3g COMPARISON")
    print("=" * 130)
